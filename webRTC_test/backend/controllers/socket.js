...
module.exports = (http) => {
  ...
  io.on('connection', (socket) => {
    ...
    socket.on("stt_data", (text) => {
      console.log("data to summarize :", text);
      let dir_path = __dirname.slice(0, -31) + 'textSummarization_test/ks4r';
      let pyfile_path = dir_path+'/__init__.py';
      console.log(dir_path, pyfile_path);
      const python = spawn('python3', [pyfile_path, text]);
